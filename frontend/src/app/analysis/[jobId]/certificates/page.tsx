        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex overflow-hidden px-4 pb-4 gap-4">
            <div className="flex-1 overflow-auto">
              <div className="grid grid-cols-[1fr_1fr_100px_100px] gap-3 px-4 py-2 text-xs font-medium text-muted-foreground border-b bg-background shadow-sm sticky top-0">
                <span>Subject</span>
                <span>Issuer</span>
                <span>Key Size</span>
                <span>Status</span>
              ...
              {certificates.map((c) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "grid grid-cols-[1fr_1fr_100px_100px] gap-3 px-4 py-2 text-xs items-center border-b border-border/50 cursor-pointer hover:bg-accent/30",
