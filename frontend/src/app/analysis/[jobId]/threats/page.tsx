        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex overflow-hidden px-4 pb-4 gap-4">
            <div className="flex-1 overflow-auto">
              <div className="grid grid-cols-[100px_1fr_90px_80px_1fr] gap-3 min-w-[520px] px-4 py-2 text-xs font-medium text-muted-foreground border-b bg-background shadow-sm sticky top-0">
                <span>Time</span>
              ...
              {filtered.slice(0, 500).map((t) => (
                <div
                  ...
                  className={cn(
                    "grid grid-cols-[100px_1fr_90px_80px_1fr] gap-3 min-w-[520px] px-4 py-2 text-xs items-center border-b border-border/50 cursor-pointer hover:bg-accent/30",
